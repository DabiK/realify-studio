          ...
          {tab === "posts" && (
            <>
                  ...
                  <section className="post-board">
                    ...
                    <div className="image-strip">
                      {pack.slots.map((slot, i) => (
                        <div className="slide" key={slot.key}>
                          <button
                            className="slide-image"
                            style={{
                              aspectRatio: pack.ratio.replace(":", " / "),
                            }}
                            disabled={!slot.active}
                            aria-label={`Ouvrir ${slot.subject}`}
                            onClick={() =>
                              setModal({ type: "image", slot: slot.key })
                            }
                          >
                            {slot.active ? (
                              <img
                                src={media(slot.active)}
                                alt={slot.subject}
                          ...
                          <div className="slide-label">
                            ...
                            {slot.active && (
                              <a
                                aria-label={`Télécharger ${slot.subject}`}
              ...
              {packs.length > 1 && (
                <>
                  <div className="section-line">
                    <h2>Les autres posts</h2>
                    <span>Votre mémoire de création</span>
                  </div>
                  <div className="collection">
                    {packs
                      ...
                      .map((p) => (
                        ...
                        >
                          {p.slots[0].active ? (
                            <img src={media(p.slots[0].active)} alt="" />
                          ) : (
                          ...
                          <div>
                            ...
                            <h3>{p.title}</h3>
                            <small>
                              {date(p.created)} · {p.slots.length} images
                            </small>
                          </div>
                          <Icon name="arrow" />
                        </button>
  ...
  return (
    <section className="post-sheet">
      ...
      <small className="download-note">
        ZIP : 5 images ordonnées + fiche du post. Sur téléphone, vous pouvez
        aussi télécharger chaque image séparément.
      </small>
